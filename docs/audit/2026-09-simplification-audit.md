...
### Clusters (224 exact, 380 near, 76 semantic)
...
- `src/grounder/symbols/events.rs:374-385` `kind_str`
- `src/grounder/symbols/events.rs:389-398` `lang_str`
...
- `src/grounder/symbols/events.rs:42-44` `project_batches`
...
- `src/grounder/symbols/extract.rs:34-168` `extract`
- `tests/simplification_audit.rs:187-461` `scan_file`
- `tests/simplification_audit.rs:1827-1933` `tokenize`

#### `dup-0207` (near, 7 sites)

Proposed home: `extract::support (consolidate these 7 sites into one function in this file)`

mechanical: normalized-token Jaccard similarity (8-token shingles, threshold 0.72)

- `src/grounder/symbols/extract.rs:819-887` `test_annotated_definitions_and_everything_nested_inside_them_are_marked_is_test`
- `src/grounder/symbols/extract.rs:890-928` `cfg_predicates_naming_test_are_recognized_and_similarly_spelled_tokens_are_not`
- `src/grounder/symbols/extract.rs:931-966` `negated_and_cfg_attr_predicates_naming_test_do_not_mark_the_item_test`
- `src/grounder/symbols/extract.rs:969-1004` `a_not_wrapping_a_non_test_atom_never_marks_the_item_test`
- `src/grounder/symbols/extract.rs:1007-1042` `compound_predicates_with_nested_negation_or_a_non_test_disjunct_do_not_mark_the_item_test`
- `src/grounder/symbols/extract.rs:1045-1085` `a_trailing_same_line_comment_on_a_cfg_test_attribute_does_not_sever_the_scan`
- `src/grounder/symbols/extract.rs:1088-1141` `an_inner_cfg_test_attribute_marks_its_enclosing_module_and_the_module_marks_its_children`
...
- `src/grounder/symbols/extract.rs:1232-1278` `extent_spans_a_destructuring_or_default_brace_signature_to_the_full_body`
- `src/grounder/symbols/extract.rs:1281-1343` `extent_generalizes_across_grammars_python_nested_def_and_js_brace_string`

#### `dup-0209` (semantic, 2 sites)
...
- `src/grounder/symbols/mod.rs:318-328` `a_file_added_to_the_tree_since_the_index_was_built_is_flagged`
- `src/grounder/symbols/mod.rs:331-346` `a_file_removed_from_the_tree_since_the_index_was_built_is_flagged`
...
- `src/grounder/symbols/model.rs:149-151` `insert_file`
- `src/grounder/symbols/model.rs:169-171` `set_hash`
...
- `tests/validate_advisories.rs:270-295` `validate_warns_of_log_bloat_with_the_measured_factor_and_names_reset_derived`
...
- `tests/code_entity_test_exclusion_periphery.rs:98-135` `is_test_false_serializes_byte_identically_to_the_pre86_form`
- `tests/code_entity_test_exclusion_periphery.rs:260-286` `is_out_of_line_module_false_serializes_byte_identically_to_the_pre_round6_form`
- `tests/code_entity_test_exclusion_periphery.rs:373-399` `path_override_none_serializes_byte_identically_to_the_pre_round7_form`
- `tests/symbol_ref_caller_attribution.rs:32-76` `a_caller_less_reference_serializes_byte_identically_to_the_pre37_form`

#### `dup-0453` (near, 3 sites)

Proposed home: `code_entity_test_exclusion_periphery::support (consolidate these 3 sites into one function in this file)`

mechanical: normalized-token Jaccard similarity (8-token shingles, threshold 0.72)

- `tests/code_entity_test_exclusion_periphery.rs:138-191` `is_test_true_serializes_the_key_and_round_trips`
- `tests/code_entity_test_exclusion_periphery.rs:289-325` `is_out_of_line_module_true_serializes_the_key_and_round_trips`
- `tests/code_entity_test_exclusion_periphery.rs:402-439` `path_override_some_serializes_the_key_and_round_trips`

#### `dup-0454` (near, 4 sites)

Proposed home: `a new shared module (sites span 2 files: tests/code_entity_test_exclusion_periphery.rs, tests/symbol_ref_caller_attribution.rs)`

mechanical: normalized-token Jaccard similarity (8-token shingles, threshold 0.72)

- `tests/code_entity_test_exclusion_periphery.rs:194-246` `a_pre86_persisted_index_with_no_is_test_key_loads_defaulting_every_item_to_false`
- `tests/code_entity_test_exclusion_periphery.rs:328-364` `a_pre_round6_persisted_index_with_no_is_out_of_line_module_key_loads_defaulting_to_false`
- `tests/code_entity_test_exclusion_periphery.rs:442-480` `a_pre_round7_persisted_index_with_no_path_override_key_loads_defaulting_to_none`
- `tests/symbol_ref_caller_attribution.rs:128-178` `a_pre37_persisted_index_loads_folding_references_caller_less`

#### `dup-0455` (near, 4 sites)

Proposed home: `code_entity_test_exclusion_periphery::support (consolidate these 4 sites into one function in this file)`

mechanical: normalized-token Jaccard similarity (8-token shingles, threshold 0.72)

- `tests/code_entity_test_exclusion_periphery.rs:620-667` `cfg_not_test_and_cfg_attr_predicates_graph_as_product_through_the_public_api`
- `tests/code_entity_test_exclusion_periphery.rs:676-708` `a_not_wrapping_a_non_test_atom_graphs_as_product_through_the_public_api`
- `tests/code_entity_test_exclusion_periphery.rs:892-927` `a_url_bearing_attribute_between_test_and_the_item_does_not_leak_the_item_into_the_graph`
- `tests/code_entity_test_exclusion_periphery.rs:1008-1041` `a_comment_mentioning_test_attribute_text_does_not_exclude_the_item_through_the_public_api`

#### `dup-0456` (near, 18 sites)

Proposed home: `code_entity_test_exclusion_periphery::support (consolidate these 18 sites into one function in this file)`

mechanical: normalized-token Jaccard similarity (8-token shingles, threshold 0.72)

- `tests/code_entity_test_exclusion_periphery.rs:825-866` `a_trailing_comment_on_cfg_test_still_excludes_the_module_through_the_public_api`
- `tests/code_entity_test_exclusion_periphery.rs:952-989` `a_multiline_cfg_test_attribute_still_excludes_the_module_through_the_public_api`
- `tests/code_entity_test_exclusion_periphery.rs:1079-1122` `a_trailing_comma_in_a_wrapped_cfg_predicate_still_excludes_the_module_through_the_public_api`
- `tests/code_entity_test_exclusion_periphery.rs:1150-1193` `an_inner_cfg_test_attribute_excludes_its_module_through_the_public_api`
- `tests/code_entity_test_exclusion_periphery.rs:1235-1277` `an_out_of_line_cfg_test_module_declaration_excludes_its_declared_file_through_the_public_api`
- `tests/code_entity_test_exclusion_periphery.rs:1296-1348` `an_out_of_line_cfg_test_module_declaration_in_a_subdirectory_excludes_its_sibling_through_the_public_api`
- `tests/code_entity_test_exclusion_periphery.rs:1501-1564` `a_non_test_out_of_line_mod_and_an_inline_test_mod_never_exclude_a_coincidentally_named_sibling_file`
- `tests/code_entity_test_exclusion_periphery.rs:1700-1754` `a_cfg_test_impl_block_excludes_its_methods_through_the_public_api`
- `tests/code_entity_test_exclusion_periphery.rs:1788-1823` `a_cfg_test_impl_block_using_the_inner_attribute_form_excludes_its_methods_through_the_public_api`
- `tests/code_entity_test_exclusion_periphery.rs:1873-1918` `cfg_test_on_every_other_item_kind_excludes_or_stays_scoped_through_the_public_api`
- `tests/code_entity_test_exclusion_periphery.rs:1938-2008` `an_out_of_line_test_mod_declared_inside_a_non_directory_style_file_resolves_correctly`
- `tests/code_entity_test_exclusion_periphery.rs:2019-2084` `an_out_of_line_test_mod_declaration_falls_back_to_a_nested_mod_rs_when_no_flat_sibling_exists`
- `tests/code_entity_test_exclusion_periphery.rs:2096-2167` `a_path_attribute_override_redirects_out_of_line_resolution_through_the_public_api`
- `tests/code_entity_test_exclusion_periphery.rs:2180-2256` `an_out_of_line_test_module_files_own_out_of_line_declarations_are_excluded_recursively_through_the_public_api`
- `tests/code_entity_test_exclusion_periphery.rs:2324-2393` `an_out_of_line_test_mod_declaration_falls_back_to_a_root_level_nested_mod_rs_when_module_dir_is_empty`
- `tests/code_entity_test_exclusion_periphery.rs:2406-2476` `a_path_attribute_override_resolves_relative_to_a_declaring_files_own_subdirectory`
- `tests/code_entity_test_exclusion_periphery.rs:2504-2558` `a_path_attribute_override_that_walks_upward_with_dotdot_still_excludes_its_target`
- `tests/code_entity_test_exclusion_periphery.rs:2573-2622` `a_path_attribute_override_with_an_explicit_dot_slash_prefix_still_resolves_to_the_same_directory_target`

#### `dup-0457` (exact, 6 sites)
...
- `tests/validate_advisories.rs:298-311` `validate_is_silent_on_log_bloat_when_every_key_is_recorded_once`
- `tests/validate_advisories.rs:314-342` `validate_is_silent_on_log_bloat_when_the_same_key_recurs_only_across_different_covered_types`
...
Recall check (spec 85 THOROUGHNESS): 30 functions drawn by seeded random index (seed `85072026`, `sample_indices` over all 5892 functions scanned in `src/` and `tests/`, excluding `tests/prioritized_plan_citation_periphery.rs` - criterion 4's own citation-guard periphery test, whose function count grows as its citation-drift-guard mechanism hardens round over round; excluding it keeps that unrelated growth from ever reshuffling this already-verified draw), each read by hand - together with its host file's surrounding context, since a duplicate can live anywhere in the file or a sibling file - to judge whether a duplicate exists that the mechanical pass and the five sweeps above did not already catch.

- `src/canary.rs:352-357` `str_field` - no duplicate found by reading
- `src/conductor.rs:7629-7663` `grounded_blast_radius` - no duplicate found by reading
- `src/conductor.rs:10578-10585` `spawn_count` - caught: `dup-0041`
- `src/conductor.rs:12968-12977` `has_unmatched_signal` - no duplicate found by reading
- `src/conductor.rs:23952-23984` `a_run_within_budget_surfaces_no_halt_reason` - no duplicate found by reading
- `src/config.rs:1128-1145` `lint_gating_verdict_lines` - no duplicate found by reading
- `src/contextgraph/sqlite.rs:2660-2697` `re_asserted_governs_folds_to_one_live_edge_with_latest_provenance` - no duplicate found by reading
- `src/contextgraph/sqlite.rs:4013-4020` `apply_batch_ref_caller` - caught: `dup-0112`
- `src/docs.rs:1951-1980` `watch_and_diagnose_churn_skills_are_parameterized_by_watch_facts` - no duplicate found by reading
- `src/eventstore/mod.rs:177-182` `placed` - no duplicate found by reading
- `src/eventstore/mod.rs:354-356` `meta_key` - no duplicate found by reading
- `src/main.rs:6854-6856` `instance_rigger_dir` - no duplicate found by reading
- `src/mcpserver.rs:131-151` `run` - no duplicate found by reading
- `src/metrics.rs:3113-3118` `model_change_treats_a_non_date_shaped_trailing_segment_as_part_of_the_base` - no duplicate found by reading
- `src/spec.rs:380-397` `ownership_advisories` - no duplicate found by reading
- `src/worktree.rs:1965-1968` `spawn_fence_is_no_spawn_when_the_unit_has_never_requested_one` - no duplicate found by reading
- `tests/change_path_revert_periphery.rs:294-404` `a_revert_through_the_shipped_build_re_emits_the_earlier_generations_recorded_keys` - no duplicate found by reading
- `tests/ci_lanes.rs:89-102` `assert_lane_command` - no duplicate found by reading
- `tests/cli.rs:6101-6248` `resumed_reviewed_unit_stamps_a_real_failed_sha_after_the_exhaustive_gates_own_deletion_is_restored` - caught: `dup-0401`
- `tests/cli.rs:22080-22091` `write_live_instance` - caught: `dup-0442`
- `tests/cli.rs:25644-25693` `step_given_a_spec_path_names_the_spec_lint_on_stderr_without_corrupting_the_wave_json` - no duplicate found by reading
- `tests/code_entity_test_exclusion_periphery.rs:1008-1041` `a_comment_mentioning_test_attribute_text_does_not_exclude_the_item_through_the_public_api` - caught: `dup-0455`
- `tests/community_resolution_knob.rs:180-189` `live_memberships` - caught: `dup-0490`
- `tests/concepts_lens_view_periphery.rs:185-213` `lens_from_query_is_a_public_total_selector_including_concepts` - caught: `dup-0471`
- `tests/dash_calls_route_periphery.rs:61-67` `code_node` - caught: `dup-0137`
- `tests/reset_build_cache_periphery.rs:36-43` `temp_project` - caught: `dup-0361`
- `tests/simplification_audit.rs:5108-5122` `two_unrelated_functions_form_no_cluster` - no duplicate found by reading
- `tests/store_content_identity_periphery.rs:583-612` `the_content_identity_policy_answers_exactly_what_it_was_configured_with` - no duplicate found by reading
- `tests/store_precedence.rs:119-139` `assert_selected_server` - caught: `dup-0651`
- `tests/turbovec_retired.rs:43-58` `table_lines` - caught: `dup-0559`
...
- `page_script` - a small JS snippet fixture - independently redefined in 18 different files (`dup-0336`, exact; e.g. `tests/adaptive_labels_periphery.rs:52-61`, `tests/code_lens_overview_collapse_viz.rs:26-35`, `tests/concepts_lens_view_periphery.rs:689-698`, + 15 more), all inside the Dashboard/viz subsystem (5.1) - cross-validates that grouping.
- `node_available` - a viz-fixture predicate - independently redefined in the same 18 files (`dup-0337`, semantic).
- `temp_project` - a scratch-project-directory fixture - independently redefined in 18 files (`dup-0362`, semantic; e.g. `tests/canary_model_drift_periphery.rs:39-46`, `tests/cause_wire_periphery.rs:54-61`, `tests/cli.rs:19-29`), plus a near-identical 12-site variant (`dup-0361`) and a 12-site `run_rigger` companion helper that drives it (`dup-0363`).
- `run_stream_identity` - a store-identity fixture - independently redefined in 18 files (`dup-0368`, semantic).
...
181 test-only clusters in the committed catalog have every site as an ordinary (non-`#[test]`) helper function - the shared-fixture-extraction candidate class. Beyond the four in 5.2, the widest are: `dup-0340` (`architecture_text` / `eventstore_source` / `main_rs_source` - source-text-loading helpers for doc/architecture-integrity checks, 12 files, 15 sites); `dup-0367` (a companion, 15-file/15-site variant of 5.2's `run_stream_identity` fixture, alongside `dup-0368`'s 18-file version); `dup-0396` (`write_two_stage_workflow` / `write_budget_one_two_stage_workflow` / `write_standalone_review_workflow` - workflow-YAML-literal builders duplicated across `tests/cli.rs` and `tests/step_attention_periphery.rs`, 4 files, 15 sites); `dup-0369`/`dup-0370` (`seed_run_events`, an event-seeding helper, 6-8 files); `dup-0460` (`apply_def_json` / `apply_ref_fresh`-shaped fold-application helpers, 5 files); `dup-0467` (`community` / `concept` / `def`-named single-field constructor helpers, 6 files); `dup-0663` (`code_lens` / `concepts_lens` two-line accessor helpers, 4 files). Every one of these 181 clusters, with its full site list and the catalog's own `proposed_home`, is already machine-readable in the committed `docs/audit/duplication-catalog.json` for a follow-up consolidation spec to consume directly - not re-enumerated exhaustively here to keep this section a report, not a second copy of the catalog.

### 5.5 Table-driven test families

159 test-only clusters have every site as a `#[test]` function - a literal-differs-only-in-input family, spec 85's own named table-driven-test candidate class. The single largest anywhere in the suite: `dup-0642` (near, 42 sites, all in `tests/spec_lint.rs`, e.g. `validate_spec_reports_every_c3_defect_with_its_criterion_and_field_guide_class:54-102`, `validate_spec_attributes_a_prose_level_defect_to_no_criterion:120-163`, `validate_spec_reports_two_simultaneous_defects_on_the_same_criterion:172-209` - 42 near-identical "feed one spec fixture through `validate`, assert one expected defect/advisory line" bodies). Proposed table: `#[test] fn validate_spec_field_guide_defects() { for (fixture, expected) in CASES { ... } }` retiring all 42 named tests into one parametrized loop over a `(&str, &str)` (or richer struct) case table. Other large families: `dup-0589`/`dup-0591` (15+7 sites, `tests/reap_before_removal_audit.rs`, "one fixture function body, one exemption-coverage shape, assert covered/not-covered" - retires into one table keyed by exemption shape); `dup-0623` (11 sites, `tests/simplification_audit.rs` - this very unit's own scanner tests, a `(source, expected_tokens_or_clusters)` table candidate); `dup-0579`/`dup-0580` (11+4 sites, `tests/no_os_kill_audit.rs`, one process-termination-pattern-string per test - a `(pattern, is_caught)` table); `dup-0582` (4 sites, `tests/no_os_kill_test_helper_periphery.rs`, `terminate_pid_refuses_pid_zero` / `_pid_one` x `stop_pid_refuses_pid_zero` / `_pid_one` - a 2x2 `(helper, pid)` table). As with 5.4, the full 157-family list lives in the committed catalog by cluster id for a follow-up test-consolidation spec to consume directly.
...
- Scope: `page_script` (`dup-0336`, 18 files), `node_available` (`dup-0337`, 18 files), `temp_project` (`dup-0362`, 18 files) and `run_stream_identity` (`dup-0368`, 18 files) - roughly 72 duplicate definitions collapsing into four shared ones, the single largest mechanical simplification section 5 identifies anywhere in the test suite.
...
- Scope, largest first: `dup-0642` (42 sites, `tests/spec_lint.rs`), `dup-0589`/`dup-0591` (15+7 sites, `tests/reap_before_removal_audit.rs`), `dup-0579`/`dup-0580` (11+4 sites, `tests/no_os_kill_audit.rs`), `dup-0623` (11 sites, `tests/simplification_audit.rs` - this very generator's own scanner tests) - 90 sites across 6 clusters.
