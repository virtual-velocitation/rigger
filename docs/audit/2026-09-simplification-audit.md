...
684 clusters (3229 total sites) across `src/` and `tests/`, found by `tests/simplification_audit.rs`'s deterministic normalized-token-shingle Jaccard pass (8-token shingles, threshold 0.72) plus five mandatory mechanical sweeps. Strict definition (spec 85 Goal): any logic present in more than one place anywhere in the codebase is a violation, with no "small enough to duplicate" exemption.

### Mandatory sweeps

- **Command::new call sites**: 265 site(s) - `dup-0006`
- **/proc-path string literals**: 59 site(s) - `dup-0127`
- **sqlite Connection::open call sites**: 46 site(s) - `dup-0105`
- **.rigger-path string literals**: 648 site(s) - `dup-0051`
- **error-shaping helper functions**: 5 site(s) - `dup-0209`

### Clusters (224 exact, 384 near, 76 semantic)
...
- `src/contextgraph/sqlite.rs:6697-6697` `Connection::open`
- `src/contextgraph/sqlite.rs:7507-7507` `Connection::open`
...
- `src/contextgraph/sqlite.rs:1855-1857` `code_entity_id`
...
- `src/contextgraph/sqlite.rs:1863-1868` `name_suffix`
...
- `src/contextgraph/sqlite.rs:1898-1904` `tier_rank`
- `src/contextgraph/sqlite.rs:1910-1916` `tier_floor_rank`
...
- `src/contextgraph/sqlite.rs:1983-2008` `calls_out`
- `src/contextgraph/sqlite.rs:2041-2066` `callers_direct`
- `src/contextgraph/sqlite.rs:2077-2105` `callers_via_bare`
...
- `src/contextgraph/sqlite.rs:2744-2758` `apply_decision`
- `src/contextgraph/sqlite.rs:4439-4446` `apply_batch_ref_caller`
...
- `src/contextgraph/sqlite.rs:2833-2846` `subgraph_finds_the_governing_decision`
- `src/contextgraph/sqlite.rs:7864-7884` `recording_proof_never_wipes_the_entitys_own_name_kind_and_line_attrs`
...
- `src/contextgraph/sqlite.rs:2977-2985` `apply_governs_at`
...
- `src/contextgraph/sqlite.rs:3268-3286` `apply_code_entity`
- `src/contextgraph/sqlite.rs:3342-3361` `apply_community`
- `src/contextgraph/sqlite.rs:4413-4424` `apply_batch_def`
- `src/contextgraph/sqlite.rs:4707-4727` `apply_batch_def_at`
...
- `src/contextgraph/sqlite.rs:3288-3293` `apply_edge_inferred`
- `src/contextgraph/sqlite.rs:3299-3304` `apply_edge_inferred_evidence`
- `src/contextgraph/sqlite.rs:3332-3338` `apply_ref_caller`
- `src/contextgraph/sqlite.rs:4091-4099` `apply_doc_concept`
- `src/contextgraph/sqlite.rs:4202-4210` `apply_doc_link`
- `src/contextgraph/sqlite.rs:4428-4434` `apply_batch_ref`
- `src/contextgraph/sqlite.rs:6042-6050` `apply_unit_integrated`
- `src/contextgraph/sqlite.rs:7313-7323` `apply_def`
...
- `src/contextgraph/sqlite.rs:4452-4466` `edges_from`
- `src/contextgraph/sqlite.rs:6770-6788` `edges_touching`
...
- `src/contextgraph/sqlite.rs:5130-5270` `calls_down_walks_the_execution_path_as_a_layered_deduped_dag_with_a_back_edge`
- `src/contextgraph/sqlite.rs:5468-5658` `calls_up_walks_the_call_sites_as_a_layered_deduped_dag_and_lists_referenced_but_not_called`
...
- `src/contextgraph/sqlite.rs:5775-5808` `decision_fold_projects_no_agent_node_or_decided_edge`
- `src/contextgraph/sqlite.rs:5862-5890` `review_finding_projects_no_raised_edge_even_with_an_event_actor`
...
- `src/contextgraph/sqlite.rs:6585-6594` `edge_projects`
- `src/contextgraph/sqlite.rs:7672-7684` `index_names`
...
- `src/contextgraph/sqlite.rs:6597-6679` `every_node_and_edge_carries_the_projects_scope_on_fold`
- `src/contextgraph/sqlite.rs:6791-6882` `prune_is_project_scoped_leaving_another_projects_same_id_node_intact`
...
- `src/contextgraph/sqlite.rs:7326-7331` `apply_ref`
...
- `src/contextgraph/sqlite.rs:7411-7452` `the_cross_file_inferred_tier_is_order_independent`
- `src/contextgraph/sqlite.rs:7455-7470` `the_definition_upgrade_never_demotes_a_same_file_extracted_reference`
...
- `src/contextgraph/sqlite.rs:7581-7583` `edge_desc`
...
- `src/contextgraph/sqlite.rs:7782-7801` `a_same_file_test_reference_increments_proven_by_and_records_its_evidence`
- `src/contextgraph/sqlite.rs:7804-7827` `two_test_references_accumulate_proven_by_to_2_with_both_evidence_entries`
...
- `src/contextgraph/sqlite.rs:7906-7937` `an_unresolvable_test_reference_is_staged_and_reconciled_once_its_definition_later_folds`
- `src/contextgraph/sqlite.rs:8182-8213` `the_empty_boundary_sentinel_never_resolves_records_or_stages_anything_for_its_empty_name`

#### `dup-0127` (semantic, 59 sites)
...
- `tests/simplification_audit.rs:3686-3686` `"Largest risk-reduction first is read as six tiers, ranked by the KIND of risk \
        ...
        Within a tier, entries are ordered largest-first by the site or line count each \
        retires - the same rule the tiers themselves follow, applied one level down.\n\n"`
- `tests/simplification_audit.rs:3769-3769` `"#### 3. Retire the duplicate `/proc`-reading authority (`dup-0127` + `dup-0128`)\n\n"`
- `tests/simplification_audit.rs:3772-3772` `"- Scope: `src/dash.rs::process_state` (`src/dash.rs:499-507`) and \
        ...
        capstone previously caught (`dup-0128`, 14 sites: `src/dash.rs`, `src/main.rs`, \
        ...
        shared composer (`dup-0127`). Both clusters' own `proposed_home` agree: `src/reap.rs` \
        ...
        rides in this same item only because it shares `dup-0127`/`dup-0128`'s one root cause \
...
- `src/grounder/symbols/events.rs:607-618` `kind_str`
- `src/grounder/symbols/events.rs:622-631` `lang_str`
...
- `src/grounder/symbols/events.rs:51-53` `project_batches`
...
- `tests/proof_lands_on_the_card_periphery.rs:696-754` `try_fetch_served`
...
- `tests/dash_kg_graph_route.rs:170-179` `fetch_served`
- `tests/proof_lands_on_the_card_periphery.rs:758-767` `fetch_served`
- `tests/rationale_overlay_data.rs:158-167` `fetch_served`
- `tests/rationale_overlay_seam.rs:121-130` `fetch_served`

#### `dup-0520` (exact, 5 sites)
...
- `tests/proof_lands_on_the_card_periphery.rs:771-775` `body_of`
...
Proposed home: `proof_lands_on_the_card_periphery::support (consolidate these 2 sites into one function in this file)`
...
Recall check (spec 85 THOROUGHNESS): 30 functions drawn by seeded random index (seed `85072026`, `sample_indices` over all 5958 functions scanned in `src/` and `tests/`, excluding `tests/prioritized_plan_citation_periphery.rs` - criterion 4's own citation-guard periphery test, whose function count grows as its citation-drift-guard mechanism hardens round over round; excluding it keeps that unrelated growth from ever reshuffling this already-verified draw), each read by hand - together with its host file's surrounding context, since a duplicate can live anywhere in the file or a sibling file - to judge whether a duplicate exists that the mechanical pass and the five sweeps above did not already catch.

- `src/conductor.rs:2477-2479` `emit_keyed` - no duplicate found by reading
- `src/conductor.rs:2581-2583` `recorded_gate_verdict` - caught: `dup-0032`
- `src/conductor.rs:13473-13554` `decomposes_the_real_spec_01_into_per_criterion_units` - no duplicate found by reading
- `src/conductor.rs:29010-29012` `build_cache_dirs` - caught: `dup-0040`
- `src/contextgraph/sqlite.rs:2307-2325` `fold_test_evidence` - no duplicate found by reading
- `src/dash.rs:1437-1550` `build_state` - no duplicate found by reading
- `src/dash.rs:10999-11026` `card_of_a_proven_code_entity_carries_proven_by_and_proof_evidence` - no duplicate found by reading
- `src/distiller.rs:595-646` `distill_output_is_deterministic_regardless_of_input_order` - no duplicate found by reading
- `src/driver/replay.rs:1929-2027` `an_emit_only_approve_gating_persona_hard_errors_on_the_replay_driver` - caught: `dup-0161`
- `src/gate.rs:1883-1891` `uncreatable_dir` - no duplicate found by reading
- `src/grounder/design/extract.rs:532-537` `first_heading` - caught: `dup-0205`
- `src/metrics.rs:1034-1047` `field_str_vec` - no duplicate found by reading
- `src/metrics.rs:2348-2376` `rejections_and_escalations_split_by_adjudicator_cause` - no duplicate found by reading
...
- `src/watch.rs:1315-1348` `an_out_of_order_tail_is_reported_naming_the_stream_and_row_count` - no duplicate found by reading
- `tests/batched_fold_cadence.rs:271-318` `append_and_fold_batch_folds_a_whole_batch_through_a_real_projector` - no duplicate found by reading
- `tests/batched_fold_cadence.rs:381-491` `ingest_project_batched_hands_whole_file_batches_and_flattens_to_the_per_event_walk` - no duplicate found by reading
- `tests/build_budget_slots_periphery.rs:84-129` `exec_runner_blocks_the_real_subprocess_on_an_externally_held_slot` - no duplicate found by reading
- `tests/cli.rs:2893-2925` `ground_via_symbols_grounder_ranks_a_definition_first` - no duplicate found by reading
- `tests/cli.rs:3646-3670` `write_budget_one_two_stage_workflow` - caught: `dup-0400`
- `tests/cli.rs:17465-17527` `docs_ships_graph_hygiene_guidance_to_consumers` - caught: `dup-0434`
...
- `tests/graph_click_to_seed_repoint.rs:310-353` `a_finding_is_attributed_only_by_its_emitting_spawn_never_a_stray_unit_field` - no duplicate found by reading
...
- `tests/reap_before_removal_audit.rs:1020-1039` `an_exemption_marker_inside_a_non_comment_string_literal_never_covers_the_removal` - caught: `dup-0595`
- `tests/reset_derived_compaction_periphery.rs:2128-2134` `guard_policy` - no duplicate found by reading
- `tests/simplification_audit.rs:4199-4208` `a_simple_free_function_is_found_with_its_line_span` - caught: `dup-0626`
- `tests/spec_lint.rs:570-602` `validate_spec_finds_an_owns_sentence_on_an_unindented_continuation_line` - caught: `dup-0646`
- `tests/subject_lens_overlay_served_page.rs:59-85` `run_node_harness` - caught: `dup-0468`
...
- `page_script` - a small JS snippet fixture - independently redefined in 19 different files (`dup-0340`, exact; e.g. `tests/adaptive_labels_periphery.rs:52-61`, `tests/code_lens_overview_collapse_viz.rs:26-35`, `tests/concepts_lens_view_periphery.rs:689-698`, + 16 more), all inside the Dashboard/viz subsystem (5.1) - cross-validates that grouping.
- `node_available` - a viz-fixture predicate - independently redefined in 19 files; the mechanical pass also clusters it together with the `gitsemver_available`/ `npm_available` availability-check helpers (5 more sites across `src/main.rs` and three test files) into one 24-site cluster (`dup-0238`, exact).
- `temp_project` - a scratch-project-directory fixture - independently redefined in 18 files (`dup-0366`, semantic; e.g. `tests/canary_model_drift_periphery.rs:39-46`, `tests/cause_wire_periphery.rs:54-61`, `tests/cli.rs:19-29`), plus a near-identical 12-site variant (`dup-0365`) and a 12-site `run_rigger` companion helper that drives it (`dup-0367`).
- `run_stream_identity` - a store-identity fixture - independently redefined in 18 files (`dup-0372`, semantic).
...
181 test-only clusters in the committed catalog have every site as an ordinary (non-`#[test]`) helper function - the shared-fixture-extraction candidate class. Beyond the four in 5.2, the widest are: `dup-0344` (`architecture_text` / `eventstore_source` / `main_rs_source` - source-text-loading helpers for doc/architecture-integrity checks, 12 files, 15 sites); `dup-0371` (a companion, 15-file/15-site variant of 5.2's `run_stream_identity` fixture, alongside `dup-0372`'s 18-file version); `dup-0400` (`write_two_stage_workflow` / `write_budget_one_two_stage_workflow` / `write_standalone_review_workflow` - workflow-YAML-literal builders duplicated across `tests/cli.rs` and `tests/step_attention_periphery.rs`, 4 files, 15 sites); `dup-0373`/`dup-0374` (`seed_run_events`, an event-seeding helper, 6-8 files); `dup-0464` (`apply_def_json` / `apply_ref_fresh`-shaped fold-application helpers, 5 files); `dup-0471` (`community` / `concept` / `def`-named single-field constructor helpers, 6 files); `dup-0667` (`code_lens` / `concepts_lens` two-line accessor helpers, 4 files). Every one of these 181 clusters, with its full site list and the catalog's own `proposed_home`, is already machine-readable in the committed `docs/audit/duplication-catalog.json` for a follow-up consolidation spec to consume directly - not re-enumerated exhaustively here to keep this section a report, not a second copy of the catalog.

### 5.5 Table-driven test families

159 test-only clusters have every site as a `#[test]` function - a literal-differs-only-in-input family, spec 85's own named table-driven-test candidate class. The single largest anywhere in the suite: `dup-0646` (near, 42 sites, all in `tests/spec_lint.rs`, e.g. `validate_spec_reports_every_c3_defect_with_its_criterion_and_field_guide_class:54-102`, `validate_spec_attributes_a_prose_level_defect_to_no_criterion:120-163`, `validate_spec_reports_two_simultaneous_defects_on_the_same_criterion:172-209` - 42 near-identical "feed one spec fixture through `validate`, assert one expected defect/advisory line" bodies). Proposed table: `#[test] fn validate_spec_field_guide_defects() { for (fixture, expected) in CASES { ... } }` retiring all 42 named tests into one parametrized loop over a `(&str, &str)` (or richer struct) case table. Other large families: `dup-0593`/`dup-0595` (15+7 sites, `tests/reap_before_removal_audit.rs`, "one fixture function body, one exemption-coverage shape, assert covered/not-covered" - retires into one table keyed by exemption shape); `dup-0627` (11 sites, `tests/simplification_audit.rs` - this very unit's own scanner tests, a `(source, expected_tokens_or_clusters)` table candidate); `dup-0582`/`dup-0583` (11+4 sites, `tests/no_os_kill_audit.rs`, one process-termination-pattern-string per test - a `(pattern, is_caught)` table); `dup-0585` (4 sites, `tests/no_os_kill_test_helper_periphery.rs`, `terminate_pid_refuses_pid_zero` / `_pid_one` x `stop_pid_refuses_pid_zero` / `_pid_one` - a 2x2 `(helper, pid)` table). As with 5.4, the full 157-family list lives in the committed catalog by cluster id for a follow-up test-consolidation spec to consume directly.
...
#### 13. Consolidate the 5 error-shaping helper sites (`dup-0209`) - caution, confirm before merging
...
- Files: `src/grounder/mod.rs`, `src/worktree.rs`, plus the three test files named in `docs/audit/duplication-catalog.json` under `dup-0209`.
...
- Scope: `page_script` (`dup-0340`, 19 files), `node_available` (`dup-0238`, 23 files - merged with two related availability-check helpers), `temp_project` (`dup-0366`, 18 files) and `run_stream_identity` (`dup-0372`, 18 files) - roughly 72 duplicate definitions collapsing into four shared ones, the single largest mechanical simplification section 5 identifies anywhere in the test suite.
...
- Scope, largest first: `dup-0646` (42 sites, `tests/spec_lint.rs`), `dup-0593`/`dup-0595` (15+7 sites, `tests/reap_before_removal_audit.rs`), `dup-0582`/`dup-0583` (11+4 sites, `tests/no_os_kill_audit.rs`), `dup-0627` (11 sites, `tests/simplification_audit.rs` - this very generator's own scanner tests) - 90 sites across 6 clusters.
...
- Scope: of the catalog's 674 clusters, 340 are test-only (items 14 and 16-18 above) and 7 are the named tier-1/tier-4 items (`dup-0006`, `dup-0051`, `dup-0105`, `dup-0127`, `dup-0128`, `dup-0201`, `dup-0209`); the remaining 327 clusters touching `src/` - mostly small 2-5-site exact/near matches like the two worked examples section 2 itself opens with (`dup-0001`, `dup-0002`) - are swept here, largest exact-duplicate clusters first, consumed directly from `docs/audit/duplication-catalog.json`.
- Files: per-cluster, from the committed catalog.
