...
pub(crate) fn render_section_5() -> String {
    ...
    out.push_str(
        ...
        different files (`dup-0337`, exact; e.g. \
    ...
    out.push_str(
        ...
        candidate class. Beyond the four in 5.2, the widest are: `dup-0341` \
        ...
        15 sites); `dup-0368` (a companion, 15-file/15-site variant of 5.2's \
        `run_stream_identity` fixture, alongside `dup-0369`'s 18-file version); \
        `dup-0397` (`write_two_stage_workflow` / \
        ...
        `dup-0370`/`dup-0371` (`seed_run_events`, an event-seeding helper, 6-8 \
        files); `dup-0459` (`apply_def_json` / `apply_ref_fresh`-shaped \
        fold-application helpers, 5 files); `dup-0466` (`community` / `concept` / \
        `def`-named single-field constructor helpers, 6 files); `dup-0662` \
    ...
    out.push_str(
        ...
        candidate class. The single largest anywhere in the suite: `dup-0641` (near, \
        ...
        `dup-0588`/`dup-0590` (15+7 sites, `tests/reap_before_removal_audit.rs`, \
...
fn render_section_6() -> String {
    ...
    out.push_str(
        "- Scope: `page_script` (`dup-0337`, 18 files), `node_available` (`dup-0338`, 18 \
        files), `temp_project` (`dup-0363`, 18 files) and `run_stream_identity` (`dup-0369`, \
    ...
    out.push_str(
        "- Scope, largest first: `dup-0641` (42 sites, `tests/spec_lint.rs`), \
        `dup-0588`/`dup-0590` (15+7 sites, `tests/reap_before_removal_audit.rs`), \
        `dup-0578`/`dup-0579` (11+4 sites, `tests/no_os_kill_audit.rs`), \
        `dup-0622` (11 sites, `tests/simplification_audit.rs` - this very \
    ...
    out.push_str(
        ...
        stated approach). Includes the `dup-0362`/`dup-0364` `temp_project` companion and \
    ...
    out.push_str(
        ...
        `docs/audit/duplication-catalog.json`. Includes `dup-0581` (4 sites, \
...
mod tests {
    ...
    fn render_section_6_cites_every_tier_and_the_explicit_none_needed_category() {
        ...
        assert!(rendered.contains("dup-0641"));
